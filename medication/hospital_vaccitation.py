...
class hospital_vaccination(models.Model):
    ...
    institution_partner_id = fields.Many2one('res.partner', string='Institution',required=True)
    ...
    medical_patient_vaccines_id = fields.Many2one('patient.info', string='Vaccination')
