...
class hospital_lab_test_invoice(models.TransientModel):
    
    _name = 'hospital.lab.test.invoice'
    _description='hospital lab test invoice'
    ...
    def create_lab_invoice(self):
        ...
        list_of_ids  = []
        lab_req_obj = self.env['hospital.patient.lab.test']
        lab_result_obj = self.env['hospital.lab']
        account_invoice_obj = self.env['account.move']
        account_invoice_line_obj = self.env['account.move.line']
        ir_property_obj = self.env['ir.property']
        for active_id in active_ids:
            if self._context['active_model'] == 'hospital.patient.lab.test':
                ...
                'invoice_origin': lab_req.hospital_test_type_id.name or '',
            ...
            if self._context['active_model'] == 'hospital.lab':
