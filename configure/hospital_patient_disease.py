...
class hospital_patient_disease(models.Model):
    _name = "hospital.patient.disease"
    _description = 'Hospital Patient Disease'
    _rec_name = 'hospital_patient_id'

    pathology_id = fields.Many2one('hospital.pathology.category','Disease', required=True)
    ...
    doctor_id = fields.Many2one('doctors.profile','Physician')
    ...
    hospital_patient_id = fields.Many2one('patient.info',string="Patient Info")
