...
class CreateAppointmentWizard(models.TransientModel):
    ...
    patient_id = fields.Many2one('patient.info', string='Patient ID', readonly=True)
    patient_name = fields.Char(string='Patient', related="patient_id.name", store=True)
    doctor_id = fields.Many2one('doctors.profile', "Doctor Name")
    ...
    def button_action_create_appointment(self):  # This button function is for the New Appointment create!
        vals = {
    ...
    @api.model  # This function to show the Create appointment wizard data from the patient.info model
    def default_get(self, fields_list):  # show the wizard form data default as per patient details
